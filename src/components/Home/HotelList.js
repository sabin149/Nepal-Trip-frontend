            ...
            <div className='container'>
                <div className='row mt-4 mx-auto'>
                    <div className='col-lg-3'>
                        ...
                        <FormControl>
                            <TextField id="outlined-basic" label="Search" variant="outlined" value={hotelNameSearch} onChange={handleSearch} />

                        </FormControl>

                        <FormControl className="mt-3">
                            <InputLabel id="demo-simple-select-label">Sort by</InputLabel>
                            <Select labelId="demo-simple-select-label" id="demo-simple-select" value={sortData} onChange={handleSort}>
                        ...
                        <FormControl variant="outlined" className="mt-3">
                            <TextField id="standard-basic" label="Price" value={price} onChange={e => setPrice(e.target.value)} required />

                            <Select labelId="demo-simple-select-label1" id="demo-simple-select1" className="mt-3" value={filterData} onChange={(e) => setFilterData(
                                e.target.value
                            )}>
                            ...
                            <Button variant="contained" color="primary" className="mt-3" onClick={handleFilter}>Submit</Button>
