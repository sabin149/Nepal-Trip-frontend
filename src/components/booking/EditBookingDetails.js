        ...
        <div className="row">
          ...
          <div className="col-6 mt-5">
            ...
            <div className="card-box mt-5">
              ...
              <p>
                Special requests are subject to availability and can't be
                guaranteed. Early check in and transfer may required an addition
                payment. Please contact the hotel to confirm.
              </p>
              <div className="">
                ...
                <div className="fields request">
                  <div className="requestform">
                    <input
                      className="form-control fnameform"
                      type="text"
                      name="requests"
