...
const Hotel = () => {
  ...
  const { hotel_name, address, phone, hotel_email, pan_no, price, hotel_info,hotel_facilities ,hotel_policies } = hotelData
        ...
        <div className="d-flex justify-content-center mx-0 mb-1">
          <div className="col-6 add_hotel" >
            ...
            <div className='hotel_label'>
              ...
              <input type="text" className="form-control hotel_input" id="exampleInputEmail1" name="pan_no" value={pan_no} onChange={handleChangeInput} />
            </div>
            ...
            <div className='hotel_label'>
              ...
              <input type="text" className="form-control hotel_input" id="exampleInputEmail1" name="hotel_facilities" value={hotel_facilities} onChange={handleChangeInput} />
            </div>
            ...
            <div className="hotel_policies">
              ...
              <input type="text" className="form-control hotel_input" id="exampleInputEmail1" name="hotel_policies" value={hotel_policies} onChange={handleChangeInput} />
              {/* <div className="col-6">
